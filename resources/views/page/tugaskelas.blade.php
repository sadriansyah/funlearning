...
@section('content')
  ...
  <div class="content-grid">
    ...
    <div class="section-header">
      ...
      <div class="section-header-info">
        ...
        <!-- SECTION TITLE -->
        <h2 class="section-title">{{$tugas->judul_tugas}}</h2>
        <!-- /SECTION TITLE -->
      </div>
      <!-- /SECTION HEADER INFO -->
      ...
      <div class="section-header-actions">
        ...
        <!-- SECTION HEADER SUBSECTION -->
        <a class="section-header-subsection" >Tugas</a>
        <!-- /SECTION HEADER SUBSECTION -->

        <!-- SECTION HEADER SUBSECTION -->
        <p class="section-header-subsection">{{$tugas->judul_tugas}}</p>
        <!-- /SECTION HEADER SUBSECTION -->
      </div>
      <!-- /SECTION HEADER ACTIONS -->
    </div>
    ...
    <div class="grid grid-9-3">
          ...
          <div class="tab-box-items">
            ...
            <div class="tab-box-item">
              ...
              <div class="tab-box-item-content">
                <!-- TAB BOX ITEM TITLE -->
                <p class="tab-box-item-title">{{$tugas->judul_tugas}}</p>
                <!-- /TAB BOX ITEM TITLE -->

                <!-- TAB BOX ITEM PARAGRAPH -->
                <p class="tab-box-item-paragraph"><?php echo htmlspecialchars_decode($tugas->deskripsi_tugas); ?></p>
                <!-- /TAB BOX ITEM PARAGRAPH -->
                ...
                <ul class="bullet-item-list">
                  ...
                  <li class="bullet-item">
                    ...
                    <!-- BULLET ITEM TEXT -->
                    <a class="bullet-item-text" target="_blank" href="{{url('/show?file='.$file->pathfile.'&kelas='.$kelas->nama_mk.$kelas->id.'&tipe=Tugas')}}">{{$file->namafile}}</a>
                    <!-- /BULLET ITEM TEXT -->
                  </li>
                  <!-- /BULLET ITEM -->
                  @endforeach
                    ...
                    @if($jawaban)
                      ...
                      <div class="product-preview small">
                        ...
                        <div class="product-preview-info">
                          <!-- TEXT STICKER -->
                          <p class="text-sticker" id="nilai{{$jwb->nim_nip}}"><span class="highlighted">Nilai </span> {{$jwb->nilai_tugas}}</p>
                          <!-- /TEXT STICKER -->
                          ...
                          <!-- PRODUCT PREVIEW CATEGORY -->
                            <p class="product-preview-category digital"><a target="_blank" href="{{url('/show?file='.$pathfile.'&kelas='.$kelas->nama_mk.$kelas->id.'&tipe=Tugas')}}" >{{$namafile}}</a></p>
                          <!-- /PRODUCT PREVIEW CATEGORY -->
                            @else
                            <!-- PRODUCT PREVIEW CATEGORY -->
      ...
      <div class="marketplace-sidebar">
        ...
        <div class="sidebar-box">
          ...
          <!-- SIDEBAR BOX TITLE -->
          <p class="sidebar-box-title medium-space">Info Tugas</p>
          <!-- /SIDEBAR BOX TITLE -->
          ...
          <div class="sidebar-box-items">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title"><a class="bold" >{{$tugas->nama_user}}</a></p>
              <!-- /USER STATUS TITLE -->

              <!-- USER STATUS TEXT -->
              <p class="user-status-text small">{{$tugas->nim_nip}}</p>
              <!-- /USER STATUS TEXT -->
            </div>
            <!-- /USER STATUS -->
          </div>
          ...
          <div class="sidebar-box-items">
            ...
            <div class="information-line-list">
              ...
              <div class="information-line">
                ...
                <p class="information-line-text"><span class="bold">{{$tugas->created_at}}</span></p>
                <!-- /INFORMATION LINE TEXT -->
              </div>
              <!-- /INFORMATION LINE -->
              ...
              <div class="information-line">
                ...
                <!-- INFORMATION LINE TEXT -->
                <p class="information-line-text"><span class="bold">{{$tugas->deadline_tanggal}}</span></p>
                <!-- /INFORMATION LINE TEXT -->
              </div>
              <!-- /INFORMATION LINE -->
              ...
              <div class="information-line">
                ...
                <!-- INFORMATION LINE TEXT -->
                <p class="information-line-text"><span class="bold">{{$tugas->deadline_jam}}</span></p>
                <!-- /INFORMATION LINE TEXT -->
              </div>
              <!-- /INFORMATION LINE -->
              @if(Auth::user()->hak_akses == "Mahasiswa")
                ...
                <div class="information-line">
                  ...
                  <!-- INFORMATION LINE TEXT -->
                  <p class="information-line-text "><a class="span text-success">{{$tugas->status}}</a></p>
                  <!-- /INFORMATION LINE TEXT -->
                  @else
                  <!-- INFORMATION LINE TEXT -->
                  <p class="information-line-text "><a class="span text-danger">{{$tugas->status}}</a></p>
                  <!-- /INFORMATION LINE TEXT -->
                  @endif
                </div>
                <!-- /INFORMATION LINE -->
              ...
              @if(Auth::user()->hak_akses=="Mahasiswa")
                ...
                <div class="information-line">
                  ...
                  <!-- INFORMATION LINE TEXT -->
                  <p class="information-line-text"><a >{{$jwb->nilai_tugas}}</a></p>
                  <!-- /INFORMATION LINE TEXT -->
                </div>
                <!-- /INFORMATION LINE -->
                @endforeach
          ...
          <div class="sidebar-box-items">
                        <!-- CHECKBOX WRAP -->
                        @if($jawabantugas)
                          @foreach($jawabantugas as $filetugas)
                          <div class="checkbox-wrap mt-4" >
                            ...
                            <!-- /CHECKBOX BOX -->
                            <a href="{{url('/show?file='.$filetugas->pathfile.'&kelas='.$kelas->nama_mk.$kelas->id.'&tipe=Tugas')}}" target="_blank">
                              <label class="accordion-trigger-linked" for="license-regular" data="{{url('/show?file='.$filetugas->pathfile.'&kelas='.$kelas->nama_mk.$kelas->id.'&tipe=Tugas')}}" id="clickjawaban" >{{$filetugas->namafile}}</label>
                            </a>
                          </div>
                          @endforeach
                        @endif
                        ...
                        <!-- /CHECKBOX WRAP -->
                        <!-- BUTTON -->
                        <form  action="{{url('/kelas/jawabtugas')}}" enctype="multipart/form-data" method="post" id="form-save">
                          @csrf
          ...
          <div class="sidebar-box-items">
            @if($jawaban)
              @foreach($jawaban as $jawab)
                @if($jawabantugas)
                  <!-- BUTTON -->
                  @foreach($jawabantugas as $jwbn)
                    <p class="button white popup-review-trigger" id="btnunsubmit" onclick="hapus({{$tugas->id}},{{$jwbn->id}},{{$kelas->id}},{{$jawab->id}})">Unsubmit</p>
                  @endforeach
                  <!-- /BUTTON -->
                @else
                <p class="button white popup-review-trigger" id="btnunsubmit" onclick="hapus({{$tugas->id}},null,{{$kelas->id}},{{$jawab->id}})">Unsubmit</p>
                @endif
  ...
  <div class="popup-box small popup-review">
    ...
    <!-- POPUP BOX TITLE -->
    <p class="popup-box-title">Unsubmit Tugas</p>
    <!-- /POPUP BOX TITLE -->


    <!-- FORM -->
    <form class="form" action="{{url('/kelas/tugas/hapusjawaban')}}" method="post">
      @csrf
      <!-- FORM ROW -->
      <div class="form-row">
        <!-- FORM ITEM -->
        <div class="form-item">
          ...
          <div class="form-input small">
            <h2>Apakah anda yakin ingin mengunsubmit tugas ini?</h2>
      ...
      <div class="popup-box-actions full void">
        ...
        <p class="popup-box-action-text">Unsubmit tugas akan menghapus file yang telah dikumpulkan!</p>
        <!-- /POPUP BOX ACTION TEXT -->
      </div>
      <!-- /POPUP BOX ACTIONS -->
    </form>
