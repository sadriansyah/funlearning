    ...
    <div class="account-hub-content">
      ...
      <div class="grid-column">
        ...
        <div class="widget-box">
          <!-- WIDGET BOX TITLE -->
          <p class="widget-box-title">Edit Ujian</p>
          <!-- /WIDGET BOX TITLE -->
          ...
          <div class="widget-box-content">
            <!-- FORM -->
            <form class="form" action="{{url('/kelas/settings/editujian')}}" method="post" enctype="multipart/form-data" id="form-save">
              @csrf
              <!-- FORM ROW -->
              ...
              <div class="form-row split">
                ...
                <div class="form-item">
                  ...
                  <div class="form-input small active">
                    <label for="profile-job-2-title">Judul Ujian</label>
                    <input type="text" id="profile-job-2-title" name="judul_ujian" value="{{$ujian->judul_ujian}}">
                  </div>
                  <!-- /FORM INPUT -->
                </div>
                <!-- /FORM ITEM -->
                ...
                <div class="form-row split">
                  ...
                  <div class="form-item">
                    ...
                    <div class="form-select  active">
                      ...
                      <input type="date" name="deadline_tanggal" class="form-control" data-date-format="DD/MMM/YYYY" value="{{$ujian->deadline_tanggal}}" id="profile-job-2-year-started">
                    </div>
                    <!-- /FORM SELECT -->
                  </div>
                  <!-- /FORM ITEM -->
                  ...
                  <div class="form-item">
                    ...
                    <div class="form-select">
                      ...
                      <input type="time" name="deadline_jam" class="form-control" value="{{$ujian->deadline_jam}}" id="profile-job-2-year-ended">
              ...
              <div class="form-row">
                ...
                <div class="form-item">
                  ...
                  <div class="form-input small mid-textarea active">
                    ...
                    <textarea id="profile-job-2-description" class="ckeditor" name="deskripsi_ujian">{{$ujian->deskripsi_ujian}}</textarea>
                  </div>
                  <!-- /FORM INPUT -->
                </div>
                <!-- /FORM ITEM -->
                ...
                <div class="form-item">
                  ...
                  <div class="form-select">
                    <select id="profile-privacy-chat-activity" name="status">
                      <option value="Open" @if($ujian->status=="Open") selected @endif>Open</option>
                      <option value="Closed" @if($ujian->status=="Closed") selected @endif>Closed</option>
                    </select>
                    <!-- FORM SELECT ICON -->
                  ...
                  <div class="photo-preview small" style="width:110px">
                    ...
                    <div class="photo-preview-info">
                      ...
                      <div class="reaction-count-list">
                        <!-- REACTION COUNT -->
                        <div class="reaction-count negative popup-review-trigger" id="hapus" onclick="hapus({{$kelas->id}},{{$ujian->id}},{{$file->id}})">
                          <!-- REACTION COUNT ICON -->
                        ...
                        <!-- REACTION COUNT -->
                        <a class="reaction-count negative" href="{{url('/file/'.$kelas->nama_mk.$kelas->id.'/ujian/'.$file->pathfile)}}" target="_blank">
                          <!-- REACTION COUNT ICON -->
                    ...
                    <!-- /PHOTO PREVIEW INFO -->
                    <a href="{{url('/file/'.$kelas->nama_mk.$kelas->id.'/ujian/'.$file->pathfile)}}" target="_blank" >{{$file->namafile}}</a>
                  </div>
                  <!-- /PHOTO PREVIEW -->
                </div>
                @endforeach
...
<div class="popup-box small popup-review">
  ...
  <!-- FORM -->
  <form class="form" action="{{url('/kelas/settings/hapusfileujian')}}" method="post">
    @csrf
    <!-- FORM ROW -->
    <div class="form-row">
      <!-- FORM ITEM -->
