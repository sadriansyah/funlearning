    ...
    <div class="account-hub-content">
      ...
      <div class="section-header">
        ...
        <div class="section-header-info">
          <!-- SECTION PRETITLE -->
          <p class="section-pretitle">Settings</p>
          <!-- /SECTION PRETITLE -->
      ...
      <div class="grid-column">
        ...
        <div class="widget-box">
          <!-- WIDGET BOX TITLE -->
          <p class="widget-box-title">Create Ujian</p>
          <!-- /WIDGET BOX TITLE -->

          <!-- WIDGET BOX CONTENT -->
          <div class="widget-box-content">
            <!-- FORM -->
            <form class="form" action="{{url('/kelas/settings/buatujian')}}" method="post" enctype="multipart/form-data" id="form-save">
              @csrf
              <!-- FORM ROW -->
              <div class="form-row split">
                ...
                <div class="form-item">
                  ...
                  <div class="form-input small">
                    ...
                    <input type="text" id="profile-job-2-title" name="judul_ujian" required>
                  </div>
                  <!-- /FORM INPUT -->
                </div>
                <!-- /FORM ITEM -->
              ...
              <div class="form-row split">
                ...
                <div class="form-item">
                  <!-- FORM SELECT -->
                  <div class="form-select">
                    <label for="tipeujian">Tipe</label>
                    <select id="tipeujian" name="tipe_ujian" required>
              ...
              <div class="form-row">
                ...
                <div class="form-item">
                  ...
                  <div class="form-input small active mid-textarea">
                    ...
                    <textarea id="profile-job-2-description" class="ckeditor" name="deskripsi_ujian" required></textarea>
                  </div>
                  <!-- /FORM INPUT -->
                </div>
                <!-- /FORM ITEM -->
